...
export default function AdminDashboard() {
  ...
  const [editingTryout, setEditingTryout] = useState<ExtendedTryout | null>(
    null,
  );
    ...
    try {
      const result = await createTryout({
        ...
        registrationDeadline: new Date(
          newTryout.registrationDeadline,
        ).toISOString(),
      });
  ...
  const startEditingTryout = (tryout: ExtendedTryout) => {
    ...
    setNewTryout({
      ...
      registrationDeadline: new Date(tryout.registrationDeadline)
        .toISOString()
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-2 bg-card p-8 rounded-2xl border border-border flex items-center justify-between shadow-xl">
            <div className="space-y-1">
              <h1 className="text-3xl font-impact tracking-wider uppercase">
                ADMIN <span className="text-primary">PANEL</span>
              </h1>
              <p className="text-muted-foreground text-sm">
                Organize tryouts and manage registrations.
              </p>
            </div>
          ...
          <div className="bg-card p-6 rounded-2xl border border-border flex flex-col justify-center shadow-lg">
            <span className="text-muted-foreground text-[10px] font-bold uppercase tracking-[0.2em] mb-1">
              Total Registrations
            </span>
            <div className="flex items-end gap-2">
              <span className="text-3xl font-impact text-white">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-900 pb-2">
          <div className="flex gap-2">
            {[
              ...
              {
                id: "create",
                label: editingTryout ? "Edit" : "New Session",
                icon: PlusCircle,
              },
            ].map((tab) => (
              <button
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {loading ? (
                  [1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-64 bg-zinc-900 rounded-xl animate-pulse border border-border"
                    />
                  ))
                ) : tryouts.length === 0 ? (
                        ...
                        <CardHeader className="border-b border-zinc-900 pb-4">
                          <div className="flex justify-between items-start">
                            <div className="space-y-1">
                              ...
                              <Badge className="bg-zinc-900 text-red-500 border-border text-[10px] font-black uppercase">
                                Active
                              </Badge>
                            </div>
                        ...
                        <CardContent className="p-6 flex-1 flex flex-col justify-between space-y-6">
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3 text-zinc-400">
                              ...
                              <span className="text-sm font-bold text-zinc-300 uppercase line-clamp-1">
                                {tryout.location}
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="pt-4 border-t border-zinc-900">
                            ...
                            <div className="w-full h-1.5 bg-zinc-900 rounded-full overflow-hidden">
                              <motion.div
                                initial={{ width: 0 }}
                                animate={{
                                  width: `${Math.min(100, (tryout._count.registrations / (Number(tryout.maxCapacity) || 100)) * 100)}%`,
                                }}
              ...
              {loading ? (
                <div className="space-y-4">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-24 bg-zinc-900 rounded-xl animate-pulse border border-border"
                    />
                  ))}
                </div>
                    ...
                    {filteredRegistrations.map((reg, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            onClick={() =>
                              setExpandedPlayerId(isExpanded ? null : reg.id)
                            }
                          ...
                          >
                            <div className="col-span-1 lg:col-span-4 flex items-center gap-3">
                              ...
                              <span className="font-impact uppercase tracking-wider text-white text-lg">
                                {reg.playerName}
                              </span>
                            </div>
                            ...
                            <div className="hidden lg:block lg:col-span-2">
                              <Badge
                                variant="secondary"
                                className="bg-zinc-900 text-zinc-400 border-border text-[10px] uppercase font-bold"
                              >
                                {reg.playerGrade}
                              </Badge>
                            </div>
                            ...
                            {isExpanded && (
                              ...
                              >
                                <div className="px-8 py-8 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-zinc-900">
                                  ...
                                  <div className="space-y-4">
                                    <div className="flex items-center gap-2 text-primary text-[10px] font-black uppercase tracking-widest">
                                      <LayoutDashboard size={12} /> Medical &
                                      Extra Info
                                    </div>
                                    <div className="p-5 bg-zinc-900/50 rounded-2xl border border-border min-h-[120px]">
                                      {reg.medicalInfo ? (
                                        ...
                                        <p className="text-sm text-zinc-600 uppercase font-black tracking-widest text-center mt-8">
                  ...
                  >
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="space-y-3">
                        <Label
                          htmlFor="ageGroup"
                          className="text-muted-foreground uppercase text-[10px] font-bold tracking-[0.2em] ml-1"
                        >
                          Age Group *
                        </Label>
                        <select
                      ...
                      <div className="space-y-3 md:col-span-2">
                        ...
                        <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wide mt-1">
                          Details will be sent via email after this deadline.
                        </p>
                      </div>
